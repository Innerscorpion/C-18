...
function setup() {
 ...
 console.log(message)
  ...
  trex = createSprite(50,windowHeight-300,20,50);
  ...
  invisibleGround = createSprite(200,windowHeight-85,400,10);
  ...
  trex.setCollider("circle",0,30,20);
  trex.debug = false
...
function spawnObstacles(){
 if (frameCount % 60 === 0){
   var obstacle = createSprite(windowWidth,windowHeight-110,10,40);
